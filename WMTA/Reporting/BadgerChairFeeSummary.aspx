<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="BadgerChairFeeSummary.aspx.cs" Inherits="WMTA.Reporting.BadgerChairFeeSummary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
        <div>
            <div class="text-align-center"><h3>Badger Chair Fee Summary</h3></div>
            <rsweb:ReportViewer ID="rptBCFeeSummary" runat="server" CssClass="report-viewer"></rsweb:ReportViewer>
        </div>
    </div>
    <script>
